...
<h1 align="center"> David Mather Portfolio 🔥 </h1> 
...
To view a live example, **[click here](https://davidmather.github.io/)**
...
- After the successful installation of `nodejs` and `npm`, clone the repository into your local system using below command:
  - ```python
     git clone https://github.com/davidmather/Portfolio-react.git
    ```
...
Note here that if you click [my portfolio](https://davidmather.github.io), you can see animating the logo at the beginning. I have designed that logo in [`Figma`](https://www.figma.com/) and then animated it using css.
...
If you can help us with these. Please don't hesitate to open an [pull request](https://github.com/davidmather/Portfolio-react/pulls) or [issue](https://github.com/davidmather/Portfolio-react/issues).
